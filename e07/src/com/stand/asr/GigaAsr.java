...
public final class GigaAsr {
    ...
    /** E07 sessions own their capture buffers; cancelled decodes cannot consume the next recording. */
    public static synchronized String finish(byte[] b) {
        if (!ensure() || b == null) return "";
