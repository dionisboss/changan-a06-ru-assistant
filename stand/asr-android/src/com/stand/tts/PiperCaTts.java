 ...
 *
 * Chinese tips ("主驾请说") are translated to Russian here (VoskBridge.ttsTextToRu); command replies
    ...
    @Override public int sendText(String text) {
        ...
        try {
            ...
            if (TONE_TEST) { pcm = tone(); Log.i(TAG, "sendText TONE for: " + text); }
                ...
                String ru = com.stand.vosk.VoskBridge.ttsTextToRu(text);  // ZH->RU (tips), Cyrillic passthrough
